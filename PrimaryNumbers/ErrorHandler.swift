    ...
    do {
     return try danger()
      ...
      alert(title: "Поиск", message: "Простые числа еще не рассчитаны")
			...
			alert(title: "Внимание!", message: "Ваши действия привели к непредвиденным ошибкам. Журнал событий зафиксирован и отправлен в службу по борьбе с дефектами. Источник проблемы будет найден и обезвреден в течении нескольких часов. Не покидайте приложение")
